...
SYMBOLS = [
    ...
    "cryXMRUSD"   # 🔒 Monero / US Dollar added here!
]
...
def on_message(ws, message):
    ...
    if "tick" in data and "quote" in data["tick"] and "symbol" in data["tick"]:
        ...
        if current_time - last_processed_times[symbol] >= CHECK_INTERVAL_SEC:
            ...
            # Dynamically isolates display labels (e.g., frxEURUSD -> EUR/USD, cryXMRUSD -> XMR/USD)
            ...
            # Formats price visualization logic cleanly based on crypto vs forex asset family weights
            if "BTC" in display_name or "XMR" in display_name:
